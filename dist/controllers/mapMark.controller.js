...
var mapMark_repository_1 = require("../repositories/mapMark.repository");
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, mapMark_repository_1.createMapMark)(req.body)];
            case 2:
                maps = _a.sent();
...
var get = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, mapMark_repository_1.getAll)()];
            case 1:
                maps = _a.sent();
                res.status(200).send(maps);
                return [3 /*break*/, 3];
...
var getId = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, mapMark_repository_1.getById)(Number(req.params.id))];
            case 1:
                getSkill = _a.sent();
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, mapMark_repository_1.updateMapMark)(Number(req.params.id), req.body)];
            case 1:
                updatedMap = _a.sent();
...
var remove = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, mapMark_repository_1.deleteMapMark)(Number(req.params.id))];
            case 1:
                _a.sent();
                res.status(200).send();
                return [3 /*break*/, 3];
