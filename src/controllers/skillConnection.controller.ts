...
import { createSkill, deleteSkill, getAll, getById, updateSkill } from '../repositories/skillConnection.repository';
import { skillConnectionValidation } from '../validations/skillConnection.validation';

export const create = async(req: Request, res: Response) => {
  try{
    await skillConnectionValidation.validate(req.body, { strict: true });
